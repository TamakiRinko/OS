...
int main(int argc, char *argv[]) {
	...
	mkdir(driver, destDirPath);
	//stringCpy("/boot/initrd", destDirPath, NAME_LENGTH - 1);	//do not create beforehand
	//touch(driver, destDirPath);
	stringCpy("/dev", destDirPath, NAME_LENGTH - 1);
	mkdir(driver, destDirPath);
	stringCpy("/dev/stdin", destDirPath, NAME_LENGTH - 1);
	touch(driver, destDirPath);
	stringCpy("/dev/stdout", destDirPath, NAME_LENGTH - 1);
	touch(driver, destDirPath);
